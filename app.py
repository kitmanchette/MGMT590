...
if filtered_df.empty:
    ...
    # Sort data alphabetically/numerically by the categorization variable for consistency
    plot_df = plot_df.sort_values(by=groupby_variable)
    ...
    fig = px.box(
        ...
        points="all", # Shows individual transaction points alongside the distribution box
        labels={groupby_variable: selected_groupby_label, 'PurchaseAmount': 'Purchase Amount Distribution ($)'},
        title=f'Purchase Amount Distribution by {selected_groupby_label}',
